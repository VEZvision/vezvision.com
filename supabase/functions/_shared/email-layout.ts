...
${data.contentHtml}
${data.footerHtml ?? defaultFooter(data.lang, data.logoUrl)}
  </table>
</body>
</html>`;
}

function defaultFooter(lang: string, logoUrl: string): string {
  const copyright =
    lang === "pl"
  ...
  return `    <tr>
      <td style="padding:20px 32px;border-top:1px solid #e5e7eb;text-align:center;">
        <p style="margin:0;font-size:11px;color:#9ca3af;">
          ${copyright} <a href="https://vezvision.com" style="color:#04070d;text-decoration:underline;">vezvision.com</a>
        </p>
      </td>
    </tr>`;
}
