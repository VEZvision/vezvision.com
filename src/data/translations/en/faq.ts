export const faqTranslations = {
  ...
  "faq.a1":
    "We build websites, web applications, online stores, and AI automations. We handle the full process: strategy, design, development, testing, deployment, and support.",
  "faq.q2": "How long does a project take?",
  "faq.a2":
    "A simple website takes 1-3 weeks. A web app or store: 3-8 weeks. Complex automations and AI integrations: 4-12 weeks. Timeline depends on scope and available materials.",
