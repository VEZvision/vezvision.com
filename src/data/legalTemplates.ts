...
2.  Poprzez gromadzenie plików "cookies" [patrz Polityka Plików Cookies](/cookie-policy).
...
## 6. Odbiorcy i Przekazywanie Danych
...
Nie stosujemy zautomatyzowanego podejmowania decyzji ani profilowania w rozumieniu art. 22 RODO. Dane osobowe nie są wykorzystywane do tworzenia profili użytkowników ani do podejmowania decyzji wyłącznie na podstawie przetwarzania automatycznego.
...
2.  Through the collection of "cookies" [see Cookie Policy](/cookie-policy).

Data provided in the form is processed for the purpose resulting from the function of a specific form, e.g. to process a contact request or present a commercial offer.
...
We do not use automated decision-making or profiling within the meaning of Article 22 GDPR. Personal data is not used to create user profiles or to make decisions based solely on automated processing.
...
1.  Usługodawca dokłada należytej staranności w celu zapewnienia prawidłowego funkcjonowania Serwisu, jednak nie ponosi odpowiedzialności za przerwy w działaniu Serwisu spowodowane siłą wyższą, awariami sprzętu, oprogramowania, sieci telekomunikacyjnych lub innych systemów niezależnych od Usługodawcy.
2.  Usługodawca nie ponosi odpowiedzialności za szkody powstałe w wyniku niedozwolonego korzystania z Serwisu przez Użytkowników lub osób trzecich.
3.  Usługodawca zastrzega, że treści zamieszczone w Serwisie mają charakter wyłącznie informacyjny i nie stanowią oferty w rozumieniu przepisów Kodeksu Cywilnego.
...
1.  Technical requirements necessary for cooperation with the ICT system used by the Service Provider:
    ...
    *   Access to e-mail - for using the contact form.
...
2.  Any use by anyone, without the express written consent of the Service Provider, of any of the elements constituting the content of the vezvision.com website constitutes a violation of the copyright belonging to the Service Provider and results in civil and criminal liability.
...
1.  The Service Provider exercises due diligence to ensure the proper functioning of the Website, but is not liable for interruptions in the operation of the Website caused by force majeure, hardware failures, software, telecommunications networks or other systems independent of the Service Provider.
2.  The Service Provider is not liable for damages arising from unauthorized use of the Website by Users or third parties.
3.  The Service Provider reserves that the content posted on the Website is for informational purposes only and does not constitute an offer within the meaning of the provisions of the Civil Code.
