            ...
            <SectionHeader
              ...
              title={
                <>
                  ...
                  <span className="font-sans font-normal">{t('products.title.line2.italic')}</span>
                </>
              }
            ...
            <div className="mx-auto max-w-4xl rounded-3xl border border-gray-100 bg-white p-8 shadow-xl md:p-12">
              <div className="grid items-center gap-6 md:grid-cols-2 md:gap-12">
                <div className="text-left">
                  <h2 className="mb-4 text-2xl font-normal text-gray-900">{t('products.card.title')}</h2>
                  <p className="mb-6 leading-relaxed text-gray-600">{t('products.card.text')}</p>
