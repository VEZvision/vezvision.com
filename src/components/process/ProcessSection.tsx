...
function ProcessSection() {
  ...
  const howToJsonLd = {
    ...
    "@type": "HowTo",
    name: t("process.title.line1") + " " + t("process.title.line2.italic"),
    description: t("process.subtitle"),
    step: [
      {
        "@type": "HowToStep",
        position: 1,
        name: t("process.analysis.title"),
        text: t("process.analysis.desc"),
      },
      {
        "@type": "HowToStep",
        position: 2,
        name: t("process.implementation.title"),
        text: t("process.implementation.desc"),
      },
      {
        "@type": "HowToStep",
        position: 3,
        name: t("process.support.title"),
        text: t("process.support.desc"),
      },
    ],
  };
  ...
  return (
    ...
    >
      <div className={styles.container}>
        ...
        <Helmet>
          <script type="application/ld+json">{safeJsonLd(howToJsonLd)}</script>
        </Helmet>
              ...
              <div className={`${styles.card} ${styles.cardTall}`}>
                ...
                <div className={styles.cardContent}>
                  <h3 className={styles.cardTitle}>
                    {t("process.analysis.title")}
                  </h3>
                  <p className={styles.cardDesc}>
                    {t("process.analysis.desc")}
                  </p>
                </div>
          ...
          <div className={styles.rightColumn}>
            ...
            <StaggerItem>
              <div className={`${styles.card} ${styles.cardMedium}`}>
                ...
                <div className={styles.cardContent}>
                  <h3 className={styles.cardTitle}>
                    {t("process.implementation.title")}
                  </h3>
                  <p className={styles.cardDesc}>
                    {t("process.implementation.desc")}
                  </p>
                </div>
                <div className={styles.stepNumber}>
