...
function StarIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 16 16" {...props} aria-hidden="true" focusable="false">
      <path
...
function WhyChooseSection() {
  ...
  const title = (
    <>
      {t("why.header.title.line1")}{" "}
      <span className="font-sans font-normal">
        {t("why.header.title.line2.italic")}
      </span>
    </>
  );
