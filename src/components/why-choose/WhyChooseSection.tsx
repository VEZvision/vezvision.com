...
const WhyChooseSection: React.FC = () => {
  ...
  // Parametry kształtu sieci – dopasowane do Figma (749_2632)
  ...
  const title = (
    <>
      {t('why.header.title.line1')} <span className="font-playfair italic font-medium">{t('why.header.title.line2.italic')}</span>
    </>
  );
          ...
          >
            <div className={styles.shapeArea} aria-hidden="true">
              <div className={styles.bars}>
                ...
                <div className={`${styles.bar} ${styles.h111}`} />
                <div className={`${styles.bar} ${styles.h102}`} />
          ...
          >
            <div className={`${styles.shapeArea} ${styles.networkShapeArea}`} aria-hidden="true">
              ...
              >
                ...
                <g stroke="url(#stemGradient)" strokeWidth="5" strokeLinecap="round" filter="url(#softShadow)">
                  ...
                  {stems.map(({ angleDeg, length }, i) => {
                    ...
                    return (
                      <g key={i}>
                        ...
                        <circle cx={x2} cy={y2} r={10} fill="#d9d9d9" />
                      </g>
                    );
                  })}
                </g>
