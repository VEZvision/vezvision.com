...
const SEO = () => {
    ...
    const ogImage = identity?.defaultOgImageUrl || identity?.logoUrl || (siteUrl ? `${siteUrl}/Logo_vezvision_optimized.svg` : '');
    ...
    return (
            ...
            <html lang={language} />
            {identity?.faviconUrl && <link rel="icon" href={identity.faviconUrl} />}
