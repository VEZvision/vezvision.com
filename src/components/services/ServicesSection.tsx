...
function ServicesSection() { const { t, language } = useLanguageContext();
...
return (
  <section ref={sectionRef} className="relative z-[1] py-12 md:py-24 lg:py-32 px-4 w-full flex flex-col items-center">
    <div className="flex flex-col items-center justify-center max-w-7xl w-full gap-8 md:gap-16">
      ...
      <SectionReveal className="flex flex-col items-center justify-center w-full max-w-3xl gap-6 text-center">
        ...
        <h2 id="services-heading" className="font-['Inter'] text-4xl md:text-5xl font-bold leading-tight -tracking-[0.02em] text-black">
          ...
          return (
            <StaggerItem key={service.id}>
              <ServiceCard
                ...
                description={translation?.excerpt || translation?.description || ''}
      ...
      {/* CTA Section */}
      <SectionReveal delay={0.15} className="w-full max-w-4xl bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-12 text-center shadow-[inset_0_3px_1px_rgba(255,255,255,1),_0_2px_4px_rgba(0,0,0,0.05)] border border-gray-100">
        <div className="flex flex-col items-center gap-6 max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-2">
            ...
            >
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="stroke-current stroke-2">
