...
function StepIcon({ index }: { index: number }) { const stroke = '#344054';
switch (index) {
  case 0:
    return (
...
function WorkflowSection() { const { t } = useLanguageContext();
  ...
  >
    <div className={styles.container}>
      <SectionHeader
        ...
        title={
          <>
            {t('workflow.header.line1')} <span className="font-sans font-semibold">{t('workflow.header.line2.italic')}</span>
          </>
        }
      ...
      <div className={styles.cta}>
        ...
        <button
          ...
          onClick={() => { void navigate(toLocalizedPath('contact')); }}
        >
