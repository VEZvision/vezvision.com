...
function Group23Section() {
  const { t } = useLanguageContext();
  return (
    <section
      id="group23"
      className={styles.section}
      aria-labelledby="group23-heading"
    >
      <div className={styles.container}>
        <SectionReveal>
          <SectionHeader
            ...
            title={
              <>
                {t("group23.header.line1")}{" "}
                <span className="font-sans font-semibold">
                  {t("group23.header.line2.italic")}
                </span>
              </>
            }
        ...
        <StaggerReveal className={styles.grid}>
          <StaggerItem>
            <article
              ...
              aria-labelledby="tile-modern-approach-heading"
            >
              <TileModernApproach />
            </article>
          </StaggerItem>
          <StaggerItem>
            <article
              className={styles.card}
              aria-labelledby="tile-always-available-heading"
            >
              <TileAlwaysAvailable />
            </article>
          </StaggerItem>
          <StaggerItem>
            <article
              className={styles.card}
              aria-labelledby="tile-real-growth-heading"
            >
              <TileRealGrowth />
            </article>
          </StaggerItem>
