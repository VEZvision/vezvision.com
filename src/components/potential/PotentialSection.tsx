...
function BarChartIcon() {
  return (
    <div className={styles.customBarIcon} aria-hidden="true">
      ...
      <div className={styles.barColumn}>
        <div className={`${styles.barMiddle} ${styles.barMedium}`} />
      </div>
      <div className={styles.barColumn}>
      ...
      <div className={styles.container}>
        <SectionReveal>
          <SectionHeader
            ...
            title={
              <>
                {t("potential.title.line1")}{" "}
                <span className="font-sans">
                  {t("potential.title.line2.italic")}
                </span>
              </>
            }
                ...
                <div className={styles.interactionMockup} aria-hidden="true">
                  ...
                  <div className={styles.suggestionList}>
                    <p className={styles.suggestionItem}>
                      {t("potential.card2.line1")}
                    </p>
                    <p className={styles.suggestionItem}>
                      {t("potential.card2.line2")}
                    </p>
                    <p className={styles.suggestionItem}>
                      {t("potential.card2.line3")}
                    </p>
                  </div>
                </div>
              </div>
