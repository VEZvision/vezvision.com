...
function ValuesSection() { const { t } = useLanguageContext();
        ...
        <div className={styles.container}>
            <SectionReveal>
                <SectionHeader
                    ...
                    title={
                        <>
                            {t('about.values.title.line1')} <span className="font-sans">{t('about.values.title.line2.italic')}</span>
                        </>
                    }
            ...
            <StaggerReveal className={styles.bentoGrid}>
                ...
                <StaggerItem className={`${styles.card} ${styles.cardWide}`}>
                    <div className={styles.imageSide}>
                        <div className={styles.imageBox}>
                            <ResponsiveImage src={valuesImg1} srcSet={valuesImg1Srcset} avifSrcSet={valuesImg1AvifSrcset} sizes="(max-width: 1024px) 50vw, 400px" alt="" className={styles.cardImage} />
                        </div>
                    </div>
                ...
                <StaggerItem className={`${styles.card} ${styles.cardWide}`}>
                    <div className={styles.imageSide}>
                        <div className={styles.imageBox}>
                            <ResponsiveImage src={valuesImg2} srcSet={valuesImg2Srcset} avifSrcSet={valuesImg2AvifSrcset} sizes="(max-width: 1024px) 50vw, 400px" alt="" className={styles.cardImage} />
                        </div>
                    </div>
                    <div className={styles.contentSide}>
                        <div className={styles.iconBox}>
