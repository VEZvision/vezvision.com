    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        {project.show_cover_image !== false && project.cover_path && (
          <div
            className={`${styles.coverCard} ${styles.coverEnter} ${motionClass}`}
          >
            ...
            <SectionReveal className={styles.card}>
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: sanitizeCmsHtml(t("description", "")),
                }}
              />
            </SectionReveal>
              ...
              {project.show_challenge !== false && (
                <SectionReveal className={styles.card} delay={0.05}>
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: sanitizeCmsHtml(t("challenge", "...")),
                    }}
                  />
                </SectionReveal>
              )}
              ...
              {project.show_solution !== false && (
                <SectionReveal className={styles.card} delay={0.1}>
                  ...
                  <div
                    className={styles.cardText}
                    dangerouslySetInnerHTML={{
                      __html: sanitizeCmsHtml(t("solution", "...")),
                    }}
                  />
                </SectionReveal>
              )}
              ...
              <div className={styles.metaItem}>
                ...
                <div>
                  <span className={styles.metaLabel}>
                    {tl("portfolio.detail.client")}
                  </span>
                  <span className={styles.metaValue}>
                    {project.client_name || tl("portfolio.detail.confidential")}
                  </span>
                </div>
              </div>
